...
const overrides = {
  ...
  'calcium-gluconate': { model: { type: 'dose', coefficient: 0.5, unit: 'mL', stock: null, mix: null, maximumDose: 20, massPerMl: 9.1, massUnit: 'mg de calcium élément' }, sourceCells: ['Gluconate de calcium PROAMP 10 % · ampoule 10 mL', '0,5 mL/kg, max. 20 mL', 'Dilution à confirmer', '', 'IV lente', ''], protocol: { posology: '0,5 mL/kg, maximum 20 mL', particulars: ['Ampoule de 10 mL = 91 mg de calcium élément.'], dilution: 'À confirmer : l’ERC ne précise pas la dilution ; le RCP PROAMP prévoit une dilution au 1/10 en cas de perfusion pédiatrique', administration: 'IV lente, sous surveillance ECG', questions: ['Décider localement injection IV lente ou perfusion diluée, et préciser la durée.'] }, sources: ['calcium'] },
